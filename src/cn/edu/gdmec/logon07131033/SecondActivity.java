package cn.edu.gdmec.logon07131033;
import cn.edu.gdmec.logon07131033.R;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myBtn2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				result.putExtra("para1", myEt1.getText().toString());
				result.putExtra("para2", myEt2.getText().toString());
